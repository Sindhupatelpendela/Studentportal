...
if (getenv('Use_Public_URL') || getenv('MYSQL_URL')) {
    // Priority: Use Public URL first (if manually added), otherwise fallback to default MYSQL_URL
    $url_string = getenv('Use_Public_URL') ?: getenv('MYSQL_URL');
